...
const MOCK_CUSTOMERS = [
  { key: 'seven_shinjuku', company: 'セブン&アイ', store: 'セブンイレブン新宿店', pipeline: 'qualified', next_action: '2026-02-02', last_contact: '2026-01-31' },
  { key: 'seven_shibuya', company: 'セブン&アイ', store: 'セブンイレブン渋谷店', pipeline: 'proposal', next_action: '2026-02-03', last_contact: '2026-01-28' },
  { key: 'lawson_ikebukuro', company: 'ローソン', store: 'ローソン池袋東口店', pipeline: 'contacted', next_action: '', last_contact: '2026-01-25' },
  { key: 'family_shinjuku', company: 'ファミリーマート', store: 'ファミマ新宿三丁目店', pipeline: 'new', next_action: '2026-02-05', last_contact: '' },
];
