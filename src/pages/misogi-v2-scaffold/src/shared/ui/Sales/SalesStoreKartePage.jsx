  ...
  if (error && !entity.saved?.log_id) {
    return (
      <div className="sales-karte-page">
        ...
        <p><Link to="/portal">Portal に戻る</Link></p>
      </div>
    );
  }
  ...
  return (
    <div className="report-page sales-karte-page" data-job="sales">
      ...
      <div className="report-page-content sales-karte-content">
        ...
        <p className="report-page-back"><Link to="/portal">Portal に戻る</Link> / <Link to="/jobs/sales/entrance">顧客へ戻る</Link> / <Link to="/sales/kartes">営業カルテ一覧</Link></p>
